#!/bin/sh
gcloud compute instances create a100-ddp-flex \
    ...
    --create-disk=auto-delete=yes,boot=yes,device-name=a100-ddp-flex,image=projects/ml-images/global/images/c0-deeplearning-common-cu124-v20250325-debian-11-py310-conda,mode=rw,size=200,type=pd-balanced \
