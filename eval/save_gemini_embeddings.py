...
python eval/save_gemini_embeddings.py \
    --run_gcs_dir gs://grouping-data/runs/gemini-embedding-2 \
...
def main(
    run_gcs_dir: str = "gs://grouping-data/runs/gemini-embedding-2",
    ...
    run_gcs_dir
        ...
        result is a drop-in `gcs_model2` for eval/compare.py.
    model
